...
is required for this project. Additionally, some students may accidentally be
in the habit of using bare `python`, which could invoke Python 2.x if their
...
class TestPythonVersion(unittest.TestCase):
    ...
    Make sure that you have a compatible version of Python and that
    you're using `python3` at the command-line (or that your environment
    resolves `python` tosome Python3.6+ version if you have a custom setup).
