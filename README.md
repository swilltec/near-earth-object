...
In this project, I used Python - and the skills we've developed in Udacity intermediate python nanodegree- to search for and explore close approaches of near-Earth objects (NEOs), using data from NASA/JPL's Center for Near Earth Object Studies.
